...
import { MenuOutline, GridOutline, CloudOutline, SwapHorizontalOutline, PeopleOutline, SettingsOutline, MoonOutline, SunnyOutline, KeyOutline, StatsChartOutline, ServerOutline, DownloadOutline, AnalyticsOutline, GitCompareOutline, SpeedometerOutline } from '@vicons/ionicons5'
...
const menuOptions: MenuOption[] = [
  ...
  { label: '数据统计', key: '/statistics', icon: () => h(NIcon, { component: AnalyticsOutline }) },
...
const currentPageTitle = computed(() => {
  const map: Record<string, string> = {
    '/': '仪表盘', '/subscriptions': '订阅管理', '/nodes': '节点管理', '/statistics': '数据统计', '/compare': '订阅对比', '/performance': '性能测试', '/convert': '在线转换',
